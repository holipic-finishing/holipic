    ...
    <v-layout row wrap>
      ...
      >
        <v-toolbar flat color="white">
          <v-toolbar-title>Manage Sales</v-toolbar-title>
        </v-toolbar>
            ...
            <v-card-title>
              ...
              <v-tooltip bottom class="icon-style custom-btn-sale">
                <v-btn
                  ...
                  dark
                  @click="exportSales()"
                  class="ml-2 btn-gradient-primary"
                >
        ...
        >
          ...
          <template slot="items" slot-scope="props">
            ...
            <td
              class="text-xs-left"
              v-if="props.item.photographer != null"
...
export default {
  ...
  methods: {
    getPhotographers() {
      ...
      get("branch/photographers?branchId=" + this.branch.branch_id).then(
        response => {
    ...
    getSalesList() {
      get("branch/sales-list?branchId=" + this.branch.branch_id).then(
        response => {
          if (response && response.success) {
    ...
    filterSale() {
      ...
      getWithData("branch/sales-list", params)
        .then(response => {
    ...
    exportSales() {
      ...
      getWithData("branch/sales-list/export", params)
        .then(response => {
