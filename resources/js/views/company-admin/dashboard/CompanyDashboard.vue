      ...
      <div class="mt-4 visitor-area-chart">
        <div class="d-custom-flex justify-space-between px-4 mb-4 label-wrap ml-3 mr-3">
          ...
          <div class="d-custom-flex justify-space-between font-weight-bold">
            <a
              class="nav-link"
              :class="typeTimeReturn === 'day' ? 'active' : '' "
              @click="activeTypeTime('day')"
            >D</a>
            <a
              class="nav-link"
              :class="typeTimeReturn === 'week' ? 'active' : '' "
              @click="activeTypeTime('week')"
            >W</a>
            <a
              class="nav-link"
              :class="typeTimeReturn === 'month' ? 'active' : '' "
              @click="activeTypeTime('month')"
            >M</a>
            <a
              class="nav-link"
              :class="typeTimeReturn === 'year' ? 'active' : '' "
              @click="activeTypeTime('year')"
            >Y</a>
          </div>
  ...
  methods: {
    ...
    reportByRangeDay() {
      ...
      if (day <= 0) {
        ...
        //view mode month
        var params = {
          start_month: moment(this.from_day, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          end_month: moment(this.to_day, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
        ...
        //view mode year
        var params = {
          start_year: moment(this.from_day, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          end_year: moment(this.to_day, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
    ...
    reportByMonth() {
      ...
      if (month <= 0) {
        ...
        var params = {
          start_month: moment(this.from_month, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          end_month: moment(this.to_month, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
        ...
        var params = {
          start_year: moment(this.from_month, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          end_year: moment(this.to_month, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
    ...
    reportByYear() {
      ...
      if (year > 5) {
        ...
        var params = {
          start_year: moment(this.from_year, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          end_year: moment(this.to_year, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
    ...
    reportByWeek() {
      ...
      if (day <= 0) {
        ...
        var params = {
          start_month: moment(this.from_day_week, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          end_month: moment(this.to_day_week, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM-DD"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
        ...
        var params = {
          start_year: moment(this.from_day_week, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          end_year: moment(this.to_day_week, "YYYY-MM-DD hh:mm:ss").format(
            "YYYY-MM"
          ),
          branch_id: this.item.branch_id,
          photographer_id: this.item.photographer_id,
