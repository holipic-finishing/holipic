      ...
      >
        ...
        >
          ...
          <template slot="items" slot-scope="props">
            ...
            <td
              v-if="props.item.customer && props.item.customer.room"
            >{{ props.item.customer.room.room_hash }}</td>
            <td v-else>No Room</td>
            <td
              v-if="props.item.customer && props.item.customer.user"
            >{{ props.item.customer.user.email }}</td>
            ...
            <td class="text-right action-width">
              ...
              <v-icon small class="mr-2 hover-icon">edit</v-icon>
              <v-icon small class="mr-2 hover-icon">delete</v-icon>
            </td>
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      del("orders/" + this.itemIdToDelete)
        .then(res => {
          if (res && res.success) {
            Vue.notify({
              type: "success",
