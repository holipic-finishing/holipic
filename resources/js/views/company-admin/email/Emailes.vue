    ...
    <v-layout row wrap>
      ...
      >
        ...
        <v-toolbar flat color="white">
          <v-toolbar-title>E-mail Templates</v-toolbar-title>
        </v-toolbar>
        ...
        <v-card-title>
          ...
          <v-btn
            ...
            color="indigo"
            @click="showEmail()"
            class="ml-2 btn-gradient-primary custom-btn btn-add"
          >
          ...
          <a
            target="_blank"
            slot="activator"
            class="btn btn-primary ml-2 btn-gradient-primary custom-btn btn-export"
            @click="exportCSV"
          >
        ...
        >
          <template slot="items" slot-scope="props">
            ...
            <td class="text-right">
              <v-icon small class="mr-2 hover-icon" @click="updateEmail(props.item)">edit</v-icon>
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      let url = "emails/" + this.itemIdToDelete;
      del(url)
        .then(res => {
          this.fetchData();
