...
import PhotographerDetail from './photographer/photographer-detail.vue'
import PhotographerAdd from './photographer/photographer-add.vue'
import PhotographerEdit from './photographer/photographer-edit.vue'
...
export default {
  	...
  	methods: {
  		fetchData()
		{
			get(config.API_URL+'photographers?userId='+this.user.id)
			.then(response => {
