          ...
          <v-layout row wrap>
            <template v-for="value in packages">
              <v-flex
                ...
                lg3
                xl12
                class="container-package-ramdom--flex"
                v-if="value.package_name == 'Package 1'"
              >
              ...
              <v-flex
                ...
                xl12
                class="container-package-ramdom--flex"
                v-else-if="value.package_name == 'Package 2'"
              >
                <div class="app-card text-xs-center">
                  <div
                    class="app-card-title success white--text d-custom-flex justify-space-between"
                  >
                    <h3 class="mb-0 white--text">{{value.package_name}}</h3>
                  </div>
                  <div class="app-full-content">
              ...
              <v-flex
                ...
                xl12
                class="container-package-ramdom--flex"
                v-else-if="value.package_name == 'Package 3'"
              >
                <div class="app-card text-xs-center">
                  <div
                    class="app-card-title warning white--text d-custom-flex justify-space-between"
                  >
                    <h3 class="mb-0 white--text">{{value.package_name}}</h3>
                  </div>
                  <div class="app-full-content">
