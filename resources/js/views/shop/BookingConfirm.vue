            ...
            <div class="row box-body-booking">
              ...
              <div class="col-4 col-type">
                <div class="container container-type">
                  <div class="content-title-booking">ORDER DETAIL</div>
                  ...
                  <table style="width: 100%">
                    ...
                    <tr v-for="detail in detailBooking">
                      ...
                      <td
                        class="th-quantity--td pt-3"
                        v-if="detail.priceNew != 0"
                      >{{detail.quantity}}</td>
                  ...
                  <div class="content-footer-booking">
                    <div class="content-footer-booking--left">TOTAL</div>
                    <div class="content-footer-booking--right">{{total}}</div>
                  </div>
                </div>
              </div>
                  ...
                  <v-container class="container-content-confirm-booking">
                    <v-form ref="form">
                      <v-layout wrap class="layout-content-confirm-booking">
                        ...
                        <v-flex xs9 lg9 md9 sm9 class="content-confirm-booking--right">
                          <div class="content-confirm-booking--right--input">
                            <v-text-field v-model="customerBooking.room" label solo disabled></v-text-field>
                          </div>
                        </v-flex>
                        ...
                        <v-flex xs9 lg9 md9 sm9 class="content-confirm-booking--right">
                          <div class="content-confirm-booking--right--input">
                            <v-text-field v-model="customerBooking.date" label solo disabled></v-text-field>
                          </div>
                        </v-flex>
  ...
  methods: {
    ...
    checkout() {
      if (this.$refs.form.validate()) {
        ...
        post("shop-selling/order-confirm", params).then(res => {});
      }
    }
  }
};
