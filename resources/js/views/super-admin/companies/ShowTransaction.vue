<template>
  ...
  >
        ...
        <div class="custom-flex">
          ...
          <div class="justify-space-between w-30">
            <div class="text-total text-xs-right">
              ...
              >{{ (!searchResult.length && on_search ==1) ? 0 : total}}$</h4>
            </div>
          </div>
        </div>
      </v-list-tile-content>
    ...
    <v-list two-line class="heigth-list-title-style">
      <v-list-tile v-for="(item, key) in optionLoadView" :key="item.id" class="style-list">
        <v-list-tile-content>
...
export default {
  ...
  methods: {
    ...
    getData(id, page, search) {
      let url = "company/history-transactions";
      ...
      switch (timevalue) {
        case "Day":
          if (this.currentFilterValue == "") {
            ...
            this.first_page_search.searchPageDay =
              this.first_page_search.searchPageDay + 1;
        ...
        case "Week":
          if (this.currentFilterValue == "") {
            ...
            this.first_page_search.searchPageWeek =
              this.first_page_search.searchPageWeek + 1;
        ...
        case "Month":
          if (this.currentFilterValue == "") {
            ...
            this.first_page_search.searchPageMonth =
              this.first_page_search.searchPageMonth + 1;
        ...
        case "Year":
          if (this.currentFilterValue == "") {
            ...
            this.first_page_search.searchPageYear =
              this.first_page_search.searchPageYear + 1;
    ...
    getDataWithTimeValue(value, page, search) {
      let url = "company/history-transactions/filter";
      ...
      getWithData(url, params)
        .then(res => {
          if (res && res.success) {
            ...
            this.check = 0;
            vm.invisibleButtonLoadMore(res.data);
      ...
      _.forEach(data, function(v_1, k_1) {
        if (v_1.status == "RECIVED") {
          var new_amount = parseFloat(
            v_1.amount * v_1.transactionexchange.exchange_rate_to_dollar
          ).toFixed(3);
