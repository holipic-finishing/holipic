...
export default {
  ...
  data () {
    return {
    	headers: [
    		...
    		{text: 'Account Holder Name' , value: 'bank_account_number' , sortable: false},
    		{text: 'Bank account number' , value: 'bank_account_number' , sortable: false},
  ...
  methods: {
  	fetchData() 
  	{
  		get(config.API_URL+'ewallet-withdraw')
  		.then(res => {
