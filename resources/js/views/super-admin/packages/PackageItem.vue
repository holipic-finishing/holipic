        ...
        <v-list two-line>
          ...
          <v-list-tile class="height-80">
            <v-list-tile-content class="h-100">
              <v-list-tile-title class="content-flex-end h-100">
                <span
                  class="font-weight-bold item-title-setting position-item"
                >Expiration Date Numbers:</span>
          ...
          <v-list-tile class="height-80">
            <v-list-tile-content class="h-100">
              <v-list-tile-title class="content-flex-end h-100">
                <span
                  class="font-weight-bold item-title-setting position-item"
                >Complimentary Bonus To TopUp:</span>
                <span class="contain-text-field-setting">
                  <v-text-field
                    placeholder="$"
                    class="font-weight-bold height-input"
          ...
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title class="d-flex">
                ...
                <span class="contain-text-field-setting">
                  <v-switch v-model="item.sms"></v-switch>
                </span>
              </v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
          ...
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title class="d-flex">
                ...
                <span class="contain-text-field-setting">
                  <v-switch v-model="item.email_service"></v-switch>
                </span>
              </v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
...
export default {
  ...
  methods: {
    ...
    fetchData(field) {
      post("edit/package/" + this.data.id, field)
        .then(res => {
          if (res && res.success) {
            this.alertStt = true;
    ...
    fetchDataSetting(field) {
      post("edit/setting/" + this.data.setting_id, field)
        .then(res => {
          if (res && res.success) {
            this.alertStt = true;
            this.alertType = "success";
